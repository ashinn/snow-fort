         ...
         (div
          ...
          (div
           ...
           (p
            ...
            "one or more " (a (@ (href . "/doc/implementations")) "alternates")
            ", separated by commas:")
           (blockquote
             (code
               "snow-chibi install --impls=gauche,racket \"(chibi match)\""))
           (p
           ...
           (p
            ...
            (code "/usr/local/share/snow/<impl>/") ".  If you don't want to "
