          ...
          `(div
             (div
               ...
               (div
                 (@ (id . "col2_3"))   ;; main
                 (h3 "Packaging")
                 (p "Snowballs are created with the " (command "package") " command. "
                 ...
                 (blockquote
                   (pre
                     (code
                       ...
                       (include \"tree.scm\")
                       (include \"earley.scm\"))")))
                     (p "This could then be packaged with: ")
                     (blockquote
                       (code
                         "snow-chibi package earley.sld"))
                     (p "This will use your local username as the author, but "
                     ...
                     (p "We don't know the license or we'd include that with the "
                     ...
                     (blockquote
                       (pre
                         (code
                           ...
                           "  earley.sld")))
                     (p "Any format (ps, pdf, html) is fine, as we simply include this "
                     ...
                     (p "Finally, a well maintained library should provide tests. "
                     ...
                     (p "The " (command "snow-chibi") " command uses "
                     ...
                     (blockquote
                       ...
                       (p "then the command becomes simply:")
                       (blockquote
                         (pre (code "snow-chibi package --authors=\"Marc Feeley\" earley.sld")))
                       (h3 "Publishing with git")
                       (p "Once we have a package the next step is to index it into your
                          git repositorys .snow-fort.scm file. This can be done with:")
                          (blockquote
                            (pre (code "snow-chibi git-index feeley-earley-1.0.tgz")))
                          (p "This will update or create .snow-fort.scm file, which is a
                             repository file containing metadata of your packages. You
                             should commit it into your git repository.")
                             (p "TODO: Write about where to add your repository as sibling")
                             (h3 "Publishing directly to snow-fort")
                             (p "Publishing directly into snow-fort is discouraged. It is better
                                to publish your package using git.")
                                (p
